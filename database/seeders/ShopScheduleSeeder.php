...
class ShopScheduleSeeder extends Seeder
{
    ...
    {
        // Default shop hours: Monday-Saturday 9 AM - 5 PM, Closed Sunday
        $defaultSchedules = [
            ...
            ['day_of_week' => 6, 'is_open' => true, 'open_time' => '08:00', 'close_time' => '17:00'], // Saturday
        ];
        ...
        foreach ($shops as $shop) {
            // Check if schedules already exist for this shop
