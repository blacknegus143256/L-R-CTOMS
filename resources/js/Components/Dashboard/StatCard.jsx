...
const StatCard = ({ title, value, trend, changePositive, icon: Icon, variant = 'default', sparkle = false }) => {
  const variants = {
  ...
  const baseClasses = 'rounded-2xl p-6 shadow-lg border hover:shadow-2xl transition-all duration-300 group hover:-translate-y-1 relative overflow-hidden';
